...
namespace Razor.Migrations
{
    ...
    [Migration("20220224085930_temp9")]
    partial class temp9
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Razor.model.Categories", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Razor.model.Product_Sell_Bill", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Sản Phẩm Bán theo hóa đơn");
                });
            ...
            modelBuilder.Entity("Razor.model.Product", b =>
                {
                    b.HasOne("Razor.model.Categories", "categories")
                        .WithMany("products")
            ...
            modelBuilder.Entity("Razor.model.Product_Sell_Bill", b =>
                {
                    b.HasOne("Razor.model.HoaDon", "hoaDon")
                        .WithMany("product_Sell_Bill")
                        .HasForeignKey("MaHoaDon")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Razor.model.Product", "product")
                        .WithMany("product_Sell_Bills")
                        .HasForeignKey("Product_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Razor.model.HoaDon", b =>
                {
                    b.Navigation("product_Sell_Bill");
                });
            ...
            modelBuilder.Entity("Razor.model.Product", b =>
                {
                    ...
                    b.Navigation("product_Sell_Bills");
                });
